...
| Touch controls reliable under multi-touch, never stick after cancel/background | PASS (unit), PENDING (e2e) | `touchHud.test.ts` (per-pointer, cancel, visibility loss, latching, dead zone). |
